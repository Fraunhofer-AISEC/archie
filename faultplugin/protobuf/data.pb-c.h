...
typedef struct Archie__MemMapInfo Archie__MemMapInfo;
...
struct  Archie__Data
{
  ...
  size_t n_mem_map_infos;
  Archie__MemMapInfo **mem_map_infos;
};
#define ARCHIE__DATA__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&archie__data__descriptor) \
, (char *)protobuf_c_empty_string, 0, (char *)protobuf_c_empty_string, 0,NULL, 0,NULL, 0,NULL, NULL, 0,NULL, 0,NULL, 0,NULL }
...
struct  Archie__MemMapInfo
{
  ProtobufCMessage base;
  uint64_t address;
  uint64_t size;
};
#define ARCHIE__MEM_MAP_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&archie__mem_map_info__descriptor) \
, 0, 0 }
...
typedef void (*Archie__FaultedData_Closure)
                 (const Archie__FaultedData *message,
                  void *closure_data);
typedef void (*Archie__MemMapInfo_Closure)
                 (const Archie__MemMapInfo *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor archie__mem_map_info__descriptor;
